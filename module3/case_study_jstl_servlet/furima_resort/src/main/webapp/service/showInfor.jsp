...
<div>
                    ...
                    <div class="col-lg-12">
                        <table id="customer" class="table table-striped table-bordered" style="width:100%;
                            ...
                            <c:forEach var="service" items="${serviceList}">
                                <tr>
                                    <td><c:out value="${service.service_id}"></c:out></td>
                                    <td><c:out value="${service.service_name}"></c:out></td>
                                    <td><c:out value="${service.service_area}"></c:out></td>
                                    <td><c:out value="${service.service_cost}"></c:out></td>
                                    <td><c:out value="${service.service_max_people}"></c:out></td>
                                    ...
                                    <td><c:out value="${service.number_of_floors}"></c:out></td>
                                    <td><c:out value="${service.rent_type_id}"></c:out></td>
                                    <td><c:out value="${service.service_type_id}"></c:out></td>
                                    <td>
                                        <a style="color: black" href="/service?action=edit&id=${service.service_id}">Update</a>
                                    </td>

                                    <td>
                                        <a href="#" onclick="setService('${service.service_id}')"
    ...
    <div>
        ...
        <form action="/service" method="get" id="formDelete">
            <input type="hidden" name="action" value="delete" />
            <input type="hidden" id="idServiceHidden" name="idServiceHidden" />
        </form>
