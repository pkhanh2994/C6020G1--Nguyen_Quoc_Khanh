...
<div>
                            ...
                            color: black;text-align: center;align-content: center;font-family: Arial;background: white">
                                ...
                                <c:forEach var="employee" items="${employeeList}">
                                    <tr>
                                        ...
                                        <td><c:out value="${employee.position_id}"></c:out></td>
                                        <td><c:out value="${employee.education_degree_id}"></c:out></td>
                                        <td><c:out value="${employee.division_id}"></c:out></td>
                                        <td><c:out value="${employee.user_name}"></c:out></td>
                                        <td>
                                            <a style="color: black" href="/employee?action=edit&id=${employee.employee_id}">Update</a>
                                        </td>

                                        <td>
                                            <a href="#" onclick="setEmployee('${employee.employee_id}')"
    ...
    <div>
        ...
        <form action="/employee" method="get" id="formDelete">
            <input type="hidden" name="action" value="delete" />
            <input type="hidden" id="idEmployeeHidden" name="idEmployeeHidden" />
        </form>
