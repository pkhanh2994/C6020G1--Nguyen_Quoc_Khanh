                        ...
                        <div class="col-lg-12">
                            ...
                            color: black;text-align: center;align-content: center;font-family: Arial;background: white">
                                ...
                                <c:forEach var="customerUsingService" items="${customerUsingServiceList}">
                                    <tr>
                                        <td><c:out value="${customerUsingService.customer_name}"></c:out></td>
                                        <td><c:out value="${customerUsingService.customer_id}"></c:out></td>
                                        <td><c:out value="${customerUsingService.attach_service_name}"></c:out></td>
